package com.kimleehan.bhproject.vrp;

import com.kimleehan.bhproject.vrp.vrp.VrpResult;
import com.kimleehan.bhproject.vrp.vrp.VrpService;
import com.kimleehan.bhproject.vrp.vrp.VrpVehicleRoute;
...
public class VrpServiceTest {
  ...
  public void 기본_예제() {
    ...
    vrpService.addShipment("감기약01", "제약회사", "약국01");
    vrpService.addShipment("감기약02", "제약회사", "약국02");
    vrpService.addShipment("감기약03", "제약회사", "약국03");
