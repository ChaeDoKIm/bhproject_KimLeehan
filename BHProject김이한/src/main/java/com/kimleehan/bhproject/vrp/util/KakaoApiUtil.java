package com.kimleehan.bhproject.vrp.util;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.kimleehan.bhproject.vrp.util.kakao.Document;
import com.kimleehan.bhproject.vrp.util.kakao.KakaoAddress;
import com.kimleehan.bhproject.vrp.util.kakao.KakaoDirections;
import lombok.Data;
...
public class KakaoApiUtil {
	private static final String REST_API_KEY = "20bdd831bf6dc471ef4f75879eaa81e4";


	// 주소 목록으로 좌표목록 받기
	public static List<Point> getPointListByAddress(List<String> addressList) throws IOException, InterruptedException {
		...
		for (String address : addressList) {
			...
			for (Document document : documents) {
				...
				point.setName(document.getAddressName());
